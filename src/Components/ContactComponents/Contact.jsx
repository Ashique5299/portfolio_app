...
function Contact() {
  return (
    <Fragment>
      <div className="text-center my-16 dark:text-white">
      ...
      <div className="md:grid grid-cols12 dark:text-white">
        <div className="flex flex-col space-y-10">
          <div className="flex items-center">
            <div className="w-14 h-14 bg-white dark:bg-[#1d222a] flex justify-center items-center rounded-full border-2 border-black dark:border-white drop-shadow-lg">
              <FaRegMap size={"24px"} />
            </div>
            <div className="h-0.5 w-12 rounded bg-black dark:bg-white" />
        ...
        <div className="mt-10 md:mt-0 flex flex-col space-y-8">
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <input
                type="text"
                className="px-6 w-full mt-2 py-3 rounded-full border-black dark:border-white dark:bg-[#1d222a] border-2"
              />
            </div>
            <div>
              <h3 className="font-semibold ml-6">
          ...
          <div>
            ...
            <textarea
              type="text-area"
              className="px-6 w-full h-40 mt-2 py-3 rounded-3xl border-black dark:border-white dark:bg-[#1d222a] border-2"
            />
          </div>
          <div className="flex justify-end mt-8 space-x-2">
            <p className="text-[#262626] dark:text-white opacity-70">
              * Accept the terms and conditions.
            </p>
            <button className="border-black dark:border-white border-2 py-2 px-4 rounded-full drop-shadow-lg bg-white dark:bg-[#1d222a]">
              SEND MESSAGE
            </button>
          </div>
        </div>
