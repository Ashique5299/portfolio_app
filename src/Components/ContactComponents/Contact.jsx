      ...
      <div className="md:grid grid-cols12">
        ...
        <div className="mt-10 md:mt-0 flex flex-col space-y-8">
          <div className="grid grid-cols-2 gap-8">
            <div>
              <h3 className="font-semibold ml-6">Your Full Name *</h3>
              <input
                type="text"
            ...
            <div>
              <h3 className="font-semibold ml-6">Your Email Address *</h3>
              <input
                type="text"
                className="px-6 w-full mt-2 py-3 rounded-full border-black border-2"
              />
          ...
          <div>
            <h3 className="font-semibold ml-6">Your Subject *</h3>
            <input
              type="text"
              className="px-6 w-full mt-2 py-3 rounded-full border-black border-2"
            />
          ...
          <div>
            <h3 className="font-semibold ml-6">Your Message *</h3>
            <textarea
              type="text-area"
