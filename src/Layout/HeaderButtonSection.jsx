...
function HeaderButtonSection({ menuOpen }) {
  return (
    <div
      ...
      } bg-white dark:bg-[#222831] z-20`}
    >
      <div className="flex flex-col justify-center h-full text-left md:text-white">
        <div className="relative flex flex-col space-y-4 ml-10 md:ml-20 pl-8 py-4 md:pl-16 border-l-2 border-black md:border-white">
